// apps/storybook/src/Statblock/Statblock.stories.ts
...
const meta: Meta<StatblockProps> = {
  title: 'Domain/Organisms/Statblock',
  parameters: {
    docs: {
      description: {
        component:
...
export const EmbedNameLevel: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'When the host document already owns an H1, set `nameLevel: 2` so the creature title does not fork the outline.',
      },
    },
  },
};
